...
export default function RealEstatePage() {
    ...
    const [lastAppraisalDate, setLastAppraisalDate] = useState('');
    
    useEffect(() => {
        // Set the date only on the client
        const today = new Date();
        const formattedDate = today.toISOString().split('T')[0];
        setLastAppraisalDate(formattedDate);
    }, []);
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="appraisalDate" type="date" value={lastAppraisalDate} onChange={e => setLastAppraisalDate(e.target.value)} />
              </div>
