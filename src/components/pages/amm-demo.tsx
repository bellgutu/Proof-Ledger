...
import { 
  ...
  ArrowLeftRight, TrendingUp, BarChart3, PieChart, Activity, Zap, Shield, Eye, Calculator, Loader2, LogOut
} from 'lucide-react';
...
export const AmmDemoProvider = ({ children }: { children: ReactNode }) => {
    ...
    const approveToken = useCallback(async (token: MockTokenSymbol, amount: string, spender: Address = AMM_CONTRACT_ADDRESS) => {
        ...
        await executeTransaction('Approve', `Approving ${amount} ${token} for AMM`, `Approve_${token}`,
